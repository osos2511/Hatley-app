...
class LocationRepoImpl implements LocationRepo{
  ...
  @override
  Future<Either<Failure, List<ZoneEntity>>> getAllZoneByGovName({required String govName}) async{
    try{
      final result=await zoneRemoteDataSource.getAllZoneByGovName(govName: govName);
      final entityList=result.map((e)=>e.toEntity()).toList();
      return Right(entityList);
    }
    on DioException catch (e) {
